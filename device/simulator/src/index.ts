...
const STEP_DISTANCE = 500; // Distance in meters for each step taken by the asset (default 500m / 1640 feet)
...
const IOT_CORE_TOPIC = "iot/assettracker";
const IOT_CERT_SECRET_ID = "assettracker/iot-cert";
